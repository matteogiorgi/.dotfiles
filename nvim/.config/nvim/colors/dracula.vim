...
let s:neodark   = g:dracula#palette.neodark
let s:neobg     = g:dracula#palette.neobg
let s:neofg     = g:dracula#palette.neofg
let s:neonc     = g:dracula#palette.neonc
let s:neoline   = g:dracula#palette.neoline
let s:neoend    = g:dracula#palette.neoend
let s:neohl     = g:dracula#palette.neohl
...
hi! link TabLine      StatusLineNC      " DraculaBoundary
hi! link TabLineFill  StatusLineNC      " DraculaBgDarker
hi! link TabLineSel   StatusLine        " Normal
hi! link Title        DraculaGreenBold
" hi! link VertSplit    StatusLineNC      " DraculaBoundary
