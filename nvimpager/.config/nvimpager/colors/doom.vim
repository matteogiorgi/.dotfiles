...
elseif &background ==# 'dark'
    highlight CursorLine
                \ gui=NONE guifg=NONE guibg='#303034'
                \ cterm=NONE ctermfg=NONE ctermbg=NONE
else
    highlight CursorLine
                \ gui=NONE guifg=NONE guibg='#F1F1F2'
                \ cterm=NONE ctermfg=NONE ctermbg=NONE
endif

call s:h('LineNr',       { 'bg': s:neobg, 'fg': s:neonc })
call s:h('NonText',      { 'bg': s:neobg, 'fg': s:neonc })
call s:h('SignColumn',   { 'bg': s:neobg, 'fg': s:neonc })
call s:h('ColorColumn',  { 'bg': s:neoend })
call s:h('CursorLine',   { 'bg': s:neoend })
call s:h('CursorLineNr', { 'bg': s:neobg, 'fg': s:neofg, 'gui': 'bold' })
call s:h('ModeMsg',      { 'bg': s:neobg, 'fg': s:neohl, 'gui': 'bold' })
call s:h('MsgArea',      { 'bg': s:neobg, 'fg': s:neofg })
call s:h('Cursor',       { 'bg': s:neofg })
call s:h('iCursor',      { 'bg': s:neohl })
call s:h('cCursor',      { 'bg': s:neofg })
call s:h('TermCursor',   { 'bg': s:neofg })
call s:h('TermCursorNC', { 'bg': s:neofg })
call s:h('Normal',       { 'bg': s:neobg })
call s:h('Terminal',     { 'bg': s:neobg, 'fg': s:foreground })
call s:h('Pmenu',        { 'bg': s:neodr, 'fg': s:neofg })
call s:h('PmenuSel',     { 'bg': s:neodrsel, 'fg': s:neofg })

if has('nvim')
    call s:h('StatusLine',   { 'bg': s:neoline, 'fg': s:neofg, 'gui': 'bold' })
    call s:h('StatusLineNC', { 'bg': s:neoline, 'fg': s:neonc, 'gui': 'bold' })
else
    call s:h('StatusLine',   { 'bg': s:neoline, 'fg': s:neofg, 'gui': 'bold' })
    call s:h('StatusLineNC', { 'bg': s:neoline, 'fg': s:neofg })
endif
...
" mhinz/vim-signify 
call s:h("SignifySignAdd", { "fg": s:function, "bg": s:neoend, "gui": "bold" })
call s:h("SignifySignChange", { "fg": s:warning, "bg": s:neoend, "gui": "bold" })
call s:h("SignifySignDelete", { "fg": s:error, "bg": s:neoend, "gui": "bold" })
...
"     autocmd!
"     autocmd InsertEnter * call s:h('CursorLineNr', { 'fg': s:neohl, 'gui': 'bold' })
"     autocmd InsertLeave * call s:h('CursorLineNr', { 'fg': s:neofg, 'gui': 'bold' })
" augroup end
"}}}
