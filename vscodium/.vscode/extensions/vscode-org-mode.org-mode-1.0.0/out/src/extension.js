...
const org_folding_and_outline_provider_1 = require("./org-folding-and-outline-provider");
function activate(context) {
    ...
    const provider = new org_folding_and_outline_provider_1.OrgFoldingAndOutlineProvider();
