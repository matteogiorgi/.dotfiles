...
let g:dracula#palette.fgline    = ['#626483', 237]
let g:dracula#palette.bgline    = ['#3A3C4E', 237]
let g:dracula#palette.crline    = ['#2E2F3E', 238]
...
let s:fgline    = g:dracula#palette.fgline
let s:bgline    = g:dracula#palette.bgline
let s:crline    = g:dracula#palette.crline
...
call s:h('DraculaLineSC', s:fg, s:bgline, [s:attrs.bold])
call s:h('DraculaLineNC', s:fgline, s:bgline, [s:attrs.bold])
call s:h('DraculaVert', s:bgline, s:none)
...
call s:h('StatusLine', s:fg, s:bgline, [s:attrs.bold])
call s:h('StatusLineNC', s:fgline, s:bgline, [s:attrs.bold])
call s:h('StatusLineTerm', s:fg, s:bgline, [s:attrs.bold])
call s:h('StatusLineTermNC', s:fgline, s:bgline, [s:attrs.bold])
call s:h('WildMenu', s:bg, s:purple, [s:attrs.bold])
call s:h('CursorLine', s:none, s:crline)
...
hi! link TabLine      DraculaLineNC
hi! link TabLineFill  DraculaLineNC
hi! link TabLineSel   DraculaLineSC
hi! link Title        DraculaGreenBold
hi! link VertSplit    DraculaVert
