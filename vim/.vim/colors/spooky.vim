...
let s:palette.blackest = [232, '#1e1f29']
let s:palette.black    = [234, '#282a36']
let s:palette.gray01   = [235, '#32343f']
let s:palette.gray02   = [238, '#3d3f49']
let s:palette.gray03   = [239, '#474952']
let s:palette.gray04   = [240, '#5c5e65']
let s:palette.gray05   = [242, '#66686e']
let s:palette.gray06   = [243, '#717278']
let s:palette.gray07   = [244, '#86878b']
let s:palette.gray08   = [245, '#909194']
let s:palette.gray09   = [246, '#9a9b9d']
let s:palette.gray10   = [247, '#afb0b0']
let s:palette.gray11   = [248, '#bababa']
let s:palette.gray12   = [249, '#c4c4c3']
let s:palette.gray13   = [250, '#d9d9d6']
let s:palette.gray14   = [251, '#e3e3df']
let s:palette.gray15   = [254, '#eeeee9']
let s:palette.white    = [255, '#f8f8f2']

let s:palette.comments = copy(s:palette.gray03)

let s:palette.purple    = [62, '#bd93f9']
let s:palette.brown     = [94, '#FFFFA5']
let s:palette.blue      = [24, '#6b89ff']
let s:palette.lightblue = [31, '#A4FFFF']
let s:palette.green     = [29, '#69FF94']
let s:palette.red       = [88, '#FF6E6E']
let s:palette.magenta   = [89, '#FF92DF']

" NeoColors
let s:palette.neodark   = [234, '#1E1F29']
let s:palette.neobg     = [236, '#282936']
let s:palette.neofg     = [253, '#BFBFBF']
let s:palette.neonc     = [ 61, '#626483']
let s:palette.neoline   = [238, '#3A3C4E']
let s:palette.neoend    = [237, '#2E2F3E']  " ['#2A2C38', 237]
let s:palette.neohl     = [228, '#F1FA8C']
...
call s:hi('ModeMsg', s:palette.neohl, [], '')
call s:hi('MoreMsg', s:palette.neohl, [], '')

call s:hi('MatchParen', s:palette.magenta, s:palette.black, '')

call s:hi('Cursor', [], s:palette.neofg, '')
call s:hi('iCursor', [], s:palette.neohl, '')
call s:hi('cCursor', [], s:palette.neofg, '')
