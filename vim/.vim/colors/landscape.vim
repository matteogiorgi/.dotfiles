...
highlight Normal gui=none guifg=#dddddd guibg=#2e3436
...
highlight VertSplit term=none gui=none guifg=black guibg=#2e3436 gui=none ctermfg=black ctermbg=darkgray cterm=none
